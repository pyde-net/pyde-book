...
- [Cryptography](chapters/08-cryptography.md)
- [MEV Protection](chapters/09-mev-protection.md)
- [Security & Threat Model](chapters/16-security.md)

# Economics & Governance

- [Gas and Fee Model](chapters/10-gas-and-fee-model.md)
- [Tokenomics](chapters/14-tokenomics.md)
...
- [Token Standard (PTS)](otigen/token-standard.md)
