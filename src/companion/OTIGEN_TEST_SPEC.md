...
| Other host fns (`origin`, `tx_hash`, `tx_gas_remaining`, `calldata_*`, `hash_keccak256`, `cross_call*`, `delegate_call`, `consume_gas`, `beacon_get`, DKG, parachain-only) | **Not mocked in v1.** Calls trap with `UnsupportedHostFn`. v2 expands. |
