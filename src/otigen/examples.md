...
| [`erc721-token`](https://github.com/pyde-net/otigen/tree/main/examples/erc721-token) | ✅ builds, 17/17 tests green | ERC721-shape NFT. Per-token ownership, `balance_of(owner)`, single-spender per-token approval cleared atomically on `transfer_from`. |
